            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href="/admin/analytics" :active="$page.url.startsWith('/admin/analytics')">
                                    Analytics
                                </NavLink>
                                <NavLink href="/admin/system-health" :active="$page.url.startsWith('/admin/system-health')">
                                    System Health
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href="/admin/analytics" :active="$page.url.startsWith('/admin/analytics')">
                            Analytics
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href="/admin/system-health" :active="$page.url.startsWith('/admin/system-health')">
                            System Health
                        </ResponsiveNavLink>
                    </div>
