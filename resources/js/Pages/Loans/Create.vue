          ...
          <div class="p-6 text-gray-900">
            ...
            <div class="mb-6">
              <div class="flex items-center space-x-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Add New Loan</h1>
              </div>
              <p class="text-gray-600">Track loans from banks, friends, or other lenders</p>
            </div>
...
const submit = () => {
  form.post('/loans', {
    onSuccess: () => {
      // Redirect to loans index after successful creation
    }
  })
}
</script>